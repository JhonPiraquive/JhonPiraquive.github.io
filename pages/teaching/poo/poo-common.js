(function () {
  ...
  /* --- Interactive mini-quiz (POO lessons) --- */
  var VF_RE = /^\s*V\/F\s*[:\.]?/i;
  ...
  function enhanceOneQuiz(heading, quizCounter) {
    if (heading.getAttribute("data-poo-quiz") === "1") return;
    ...
    var qid = heading.id || "poo-quiz-" + quizCounter;

    var wrap = document.createElement("div");
    wrap.className = "poo-quiz";
    wrap.setAttribute("data-poo-quiz-root", qid);

    var toolbar = document.createElement("div");
    toolbar.className = "poo-quiz-toolbar";
    var scoreEl = document.createElement("span");
    scoreEl.className = "poo-quiz-score";
    scoreEl.setAttribute("aria-live", "polite");
    var btnRow = document.createElement("div");
    btnRow.className = "poo-quiz-actions";
    var btnCheck = document.createElement("button");
    btnCheck.type = "button";
    btnCheck.className = "poo-quiz-btn poo-quiz-btn-primary";
    btnCheck.textContent = "Comprobar todo";
    var btnReset = document.createElement("button");
    btnReset.type = "button";
    btnReset.className = "poo-quiz-btn poo-quiz-btn-ghost";
    ...
    listWrap.className = "poo-quiz-questions";
    ...
    function evaluateIndex(idx, silent) {
      ...
      if (!got && q.kind === "text") {
        ...
        field.classList.remove("poo-quiz-q--ok", "poo-quiz-q--bad");
        return;
      }
      if (!got && q.kind !== "text") {
        st.answered = false;
        if (!silent) {
          ...
          field.classList.remove("poo-quiz-q--ok");
          field.classList.add("poo-quiz-q--bad");
        }
        return;
      }
      var ok = false;
      ...
      st.correct = ok;
      field.classList.remove("poo-quiz-q--ok", "poo-quiz-q--bad");
      field.classList.add(ok ? "poo-quiz-q--ok" : "poo-quiz-q--bad");
      if (!silent) {
    ...
    for (var iq = 0; iq < model.questions.length; iq++) {
      (function (idx) {
        ...
        field.className = "poo-quiz-q";
        field.setAttribute("data-q-index", String(idx));

        var leg = document.createElement("legend");
        leg.innerHTML =
          '<span class="poo-quiz-num">' +
          (idx + 1) +
          '</span><span class="poo-quiz-qtext">' +
          q.html +
          "</span>";

        var controls = document.createElement("div");
        controls.className = "poo-quiz-controls";

        var fb = document.createElement("p");
        fb.className = "poo-quiz-feedback";
        ...
        if (q.kind === "vf") {
          ...
          vfRow.className = "poo-quiz-vf";
          ["V", "F"].forEach(function (letter) {
            var b = document.createElement("button");
            b.type = "button";
            b.className = "poo-quiz-chip";
            b.textContent = letter === "V" ? "Verdadero" : "Falso";
            b.setAttribute("aria-pressed", "false");
            b.addEventListener("click", function () {
              vfRow.querySelectorAll(".poo-quiz-chip").forEach(function (x) {
                x.classList.remove("poo-quiz-chip--sel");
                x.setAttribute("aria-pressed", "false");
              });
              b.classList.add("poo-quiz-chip--sel");
          ...
          q.options.forEach(function (opt, oi) {
            ...
            span.className = "poo-quiz-opt-body";
          ...
          tin.type = "text";
          tin.className = "poo-quiz-text-input";
    ...
    details.className = "poo-quiz-key";
    ...
    keyClone.classList.add("poo-quiz-key-plain");
    ...
    btnReset.addEventListener("click", function () {
      states.forEach(function (st, si) {
        ...
        st.field.classList.remove("poo-quiz-q--ok", "poo-quiz-q--bad");
        ...
        if (qq.kind === "mcq") {
          ...
          st.field.querySelectorAll(".poo-quiz-chip").forEach(function (x) {
            x.classList.remove("poo-quiz-chip--sel");
            x.setAttribute("aria-pressed", "false");
          });
        } else {
    ...
    heading.setAttribute("data-poo-quiz", "1");
  ...
  function initMiniQuizzes() {
    var root = document.querySelector(".poo-content");
    if (!root) return;
