...
export function TiposApiSection() {
  return (
    <section>
      <h2 className="mb-4 text-2xl font-bold text-[var(--color-primary)]">{"Tipos de API"}</h2>
      ...
      <ul className="my-4 list-disc pl-6">
        ...
        <li>{"Cada tipo implica distintos riesgos de exposición y modelos de consumo."}</li>
      </ul>
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Clasificación visual"}</h3>
      <MermaidDiagram
        chart={`flowchart TD
  ...
  ARQ --> GRPC[gRPC protobuf]`}
      ...
      <ul className="my-4 list-disc pl-6">
        ...
        <li>{"GraphQL: el cliente define la forma de la respuesta en una sola consulta."}</li>
        <li>{"gRPC: alto rendimiento con Protocol Buffers; común en microservicios internos."}</li>
      </ul>
