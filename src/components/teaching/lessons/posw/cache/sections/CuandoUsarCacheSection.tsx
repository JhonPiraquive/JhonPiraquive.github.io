...
export function CuandoUsarCacheSection() {
  return (
    <section>
      ...
      <MermaidDiagram
        title="Mapa mental — CuandoUsarCache"
        chart={`mindmap
  root((CuandoUsarCache))
    Sí cachear
    Con cuidado
    No cachear`}
      />
      ...
      <CompareTable
        ...
        rows={[
          [
            ...
            "Sí",
            "1 año, immutable",
            "Bajo — hash cambia con contenido",
          ],
          [
            "Catálogo productos",
            "Sí",
            "Redis 5–10 min + invalidación",
            "Stock/precio desactualizado",
          ],
          [
            "GET /usuario/me",
            "No o private corto",
            "no-store",
            "Filtración entre usuarios",
          ],
          ["Token JWT", "NUNCA", "no-store", "Robo de sesión"],
          [
            "Inventario crítico",
            "TTL corto + event-based",
            "Invalidar al UPDATE",
            "Venta de stock inexistente",
          ],
        ]}
      />
