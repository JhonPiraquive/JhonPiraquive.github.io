...
export function HeadersCacheSection() {
  return (
    <section>
      <h2 className="mb-4 text-2xl font-bold text-[var(--color-primary)]">{"Headers HTTP de caché"}</h2>
...
Cache-Control: no-store, no-cache, private`}
      />
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Directivas Cache-Control"}</h3>
      <CompareTable
