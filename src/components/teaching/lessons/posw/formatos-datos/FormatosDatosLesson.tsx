...
import { ComparativaXmlJsonSection } from "./sections/ComparativaXmlJsonSection";
import { CasosDeUsoSection } from "./sections/CasosDeUsoSection";
...
export default function FormatosDatosLesson({ locale }: Props) {
  return (
    <LessonLayout
      title={meta.title}
      track={meta.track}
