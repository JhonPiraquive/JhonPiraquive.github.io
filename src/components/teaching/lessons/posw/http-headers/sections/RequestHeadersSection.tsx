...
export function RequestHeadersSection() {
  return (
    <section>
      <h2 className="mb-4 text-2xl font-bold text-[var(--color-primary)]">{"Request headers"}</h2>
      ...
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Headers de petición frecuentes"}</h3>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            ...
            <tr className="bg-[var(--color-neutral-light)]/50">
              ...
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">{"Credenciales"}</td>
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">
            ...
            <tr className="bg-white">
              ...
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">{"Tipos de media aceptados"}</td>
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">
            ...
            <tr className="bg-[var(--color-neutral-light)]/50">
              ...
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">{"Tipo del body enviado"}</td>
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">
            ...
            <tr className="bg-white">
              ...
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">{"Identificador del cliente"}</td>
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">
            ...
            <tr className="bg-[var(--color-neutral-light)]/50">
              ...
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">{"Estado en cliente"}</td>
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">
            ...
            <tr className="bg-white">
              ...
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">{"Origen del navegador (CORS)"}</td>
              <td className="border-b border-[var(--color-neutral-mid)]/20 px-4 py-3">
...
`}
      />
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Errores frecuentes en request"}</h3>
      <ul className="my-4 list-disc pl-6">
        <li>
