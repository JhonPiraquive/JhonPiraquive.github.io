...
export function SeguridadHeadersSection() {
  return (
    <section>
      <h2 className="mb-4 text-2xl font-bold text-[var(--color-primary)]">{"Headers de seguridad"}</h2>
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Mapa mental"}</h3>
      <ul className="my-4 list-disc pl-6">
        <li>{"Capa de defensa en el navegador del usuario."}</li>
        <li>{"Complementan (no reemplazan) sanitización de entrada y HTTPS."}</li>
        <li>{"HSTS, CSP, X-Frame-Options, nosniff son esenciales en producción."}</li>
      </ul>
      <CompareTable
