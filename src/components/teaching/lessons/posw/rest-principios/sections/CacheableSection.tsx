...
export function CacheableSection() {
  return (
    <section>
      <h2 className="mb-4 text-2xl font-bold text-[var(--color-primary)]">{"Cacheable"}</h2>
      ...
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Respuesta cacheable (catálogo público)"}</h3>
      <CodeFiddle
        language="http"
...
Content-Type: application/json`}
      />
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Respuesta no cacheable (dato de usuario)"}</h3>
      <CodeFiddle
        language="http"
...
Content-Type: application/json`}
      />
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Sin headers = problema REST"}</h3>
      <p className="my-4">
        {
