...
import { QueEsServicioWebSection } from "./sections/QueEsServicioWebSection";
import { ObjetivosServiciosWebSection } from "./sections/ObjetivosServiciosWebSection";
import { IntroSolidPreviewSection } from "./sections/IntroSolidPreviewSection";
...
export default function ServiciosWebLesson({ locale }: Props) {
  return (
    <LessonLayout
      title={meta.title}
      track={meta.track}
