  ...
  return (
    <section>
      ...
      <ul className="my-4 list-disc pl-6">
        <li>{"Interoperabilidad: Java, Python, Go, C# se comunican con estándares abiertos."}</li>
        <li>{"Compartir datos y lógica: una sola fuente de verdad para web, móvil y batch."}</li>
        <li>{"Escalabilidad independiente: escalar solo el módulo con más carga."}</li>
        <li>{"Modularidad: microservicios con responsabilidades acotadas."}</li>
        <li>{"Estandarización: HTTP, JSON, REST reducen fricción entre equipos."}</li>
        <li>{"Acceso remoto: servicios alcanzables por internet entre organizaciones."}</li>
      </ul>
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Para qué sirve cada objetivo"}</h3>
      <table className="my-4 w-full border-collapse text-sm">
        <thead>
          <tr className="border-b border-[var(--color-neutral-mid)]">
            <th className="py-2 pr-4 text-left font-semibold">{"Objetivo"}</th>
            <th className="py-2 pr-4 text-left font-semibold">{"Qué resuelve"}</th>
            <th className="py-2 text-left font-semibold">{"Ejemplo concreto"}</th>
          </tr>
        </thead>
        <tbody>
          <tr className="border-b border-[var(--color-neutral-mid)]/40">
            ...
            <td className="py-2">{"App Kotlin consume API Java vía HTTP+JSON"}</td>
          </tr>
          <tr className="border-b border-[var(--color-neutral-mid)]/40">
            <td className="py-2 pr-4">{"Compartir datos"}</td>
            <td className="py-2 pr-4">{"Evitar reglas duplicadas en cada cliente"}</td>
            <td className="py-2">{"Un solo servicio de pagos para web y móvil"}</td>
          </tr>
          <tr className="border-b border-[var(--color-neutral-mid)]/40">
            <td className="py-2 pr-4">{"Escalabilidad"}</td>
            <td className="py-2 pr-4">{"No escalar todo el monolito por un cuello de botella"}</td>
            <td className="py-2">{"Solo el servicio de catálogo en Black Friday"}</td>
          </tr>
          <tr className="border-b border-[var(--color-neutral-mid)]/40">
            <td className="py-2 pr-4">{"Modularidad"}</td>
            <td className="py-2 pr-4">{"Cambios localizados y despliegues independientes"}</td>
            <td className="py-2">{"Servicio de notificaciones separado de usuarios"}</td>
          </tr>
          <tr className="border-b border-[var(--color-neutral-mid)]/40">
          ...
          <tr className="border-b border-[var(--color-neutral-mid)]/40">
            ...
            <td className="py-2">{"Partner externo consume tu API de inventario"}</td>
          </tr>
        </tbody>
      </table>
      <StepReveal
      ...
      <h3 className="mt-6 mb-2 text-xl font-semibold">{"Flujo típico de una operación"}</h3>
      <p className="my-4">
        {
