    ...
    Stateless y cacheable`}
      ...
      <CompareTable
        ...
        rows={[
          [
            "Stateless",
            "Cada petición lleva toda la info necesaria; sin sesión en servidor",
          ],
  ...
  "_links": {
    ...
    "categoria": "/api/v1/categorias/3"
      ...
      <PracticeExercise
        ...
        hints={[
          "JSON es ligero",
          "OpenAPI documenta REST",
          "SOAP es verboso para móvil",
        ]}
