...
export function SistemaTiposSection() {
  return (
    <section>
      ...
      <MermaidDiagram
        title="Mapa mental — Sistema Tipos"
  ...
  root((Sistema Tipos))
    ...
    any vs unknown any desactiva el tipado
    never funciones que nunca retornan error o bucle infinito`}
      />
  ...
  console.log(desconocido.toUpperCase());
      ...
      <CompareTable
        ...
        rows={[
          [
            "any",
            "Desactiva verificación",
            "Migración gradual legacy",
            "Anula beneficios de TS",
          ],
          [
            "unknown",
          ...
          [
            "never",
            "Valor imposible",
            "Funciones que lanzan o no retornan",
            "Útil en exhaustiveness checks",
          ],
        ]}
      />
      <h3 className="mt-6 mb-2 text-xl font-semibold">
