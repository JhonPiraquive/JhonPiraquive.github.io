...
export const TRACKS = [
  ...
  },
  {
    ...
    descEs: "Programación Orientada a Objetos (POO) con C#, diagramas y principios SOLID.",
  ...
  {
    id: "configuracion-sistemas-operativos",
    icon: "🖥️",
    titleEs: "Configuración de Sistemas Operativos",
    titleEn: "Operating Systems Configuration",
